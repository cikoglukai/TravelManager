    ...
    <div v-else-if="trip">
      <div class="trip-detail">
        <div class="trip-detail-header">
          ...
          <div class="trip-author-row" v-if="trip.user_uid && !isOwner">
            <NuxtLink :to="`/users/${trip.user_uid}`" class="author-link">
              by <strong>{{ trip.user_name || trip.user_uid }}</strong>
            </NuxtLink>
            <FollowButton :user-uid="trip.user_uid" />
          </div>
        </div>
